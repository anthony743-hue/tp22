...
?>
    <main class="container py-4">
        ...
        <div class="table-container" style="overflow-y: scroll; height: 380px;">
                        ...
                        <tbody>
                            <?php $count = 0; foreach ($resultsToDisplay as $employee) { $count++; ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="modal.php?p=fiche.php&nom=<?= urlencode($employee['first_name']); ?>&prenom=<?= urlencode($employee['last_name']); ?>" class="d-inline-flex focus-ring focus-ring-primary py-1 px-2 text-decoration-none border rounded-2">
                                            Voir plus
                                        </a>
                                    </td>
                                    </tr>
